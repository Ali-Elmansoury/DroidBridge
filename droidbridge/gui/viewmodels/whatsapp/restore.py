...
class RestoreViewModel(QObject):
    ...
    def restore(self, app, src, conflict, verify):
        client, serial = self.context.client, self.context.serial
        self.logMessage.emit("Restoring...", "INFO")
        fn = functools.partial(whatsapp_ops.run_restore, client, serial, app, src, conflict, verify)
    ...
    def _on_done(self, result):
        ...
        message = "Restore complete — " + ", ".join(parts) + "."
