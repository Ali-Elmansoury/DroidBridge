...
class BackupRestorePanel(QWidget):
    ...
    def _build_ui(self):
        ...
        self.backup_button.setToolTip("Pull the selected app's APK file(s) into a backup folder you choose.")
        ...
        self.browse_button.setToolTip("Select a folder containing a previously backed-up APK bundle.")
        ...
        self.allow_downgrade_checkbox.setToolTip("Allow installing this APK even if it's an older version than what's installed.")
        restore_layout.addWidget(self.allow_downgrade_checkbox)
        self.restore_button = QPushButton("Restore")
        self.restore_button.setEnabled(False)
        self.restore_button.setToolTip("Install the selected APK bundle to the device.")
        restore_layout.addWidget(self.restore_button)
        self.restore_status_label = QLabel()
        self.restore_status_label.setWordWrap(True)
