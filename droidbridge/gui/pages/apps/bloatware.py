...
class BloatwarePanel(QWidget):
    ...
    def _build_ui(self):
        ...
        self.disable_button.setToolTip("Disable the selected app without uninstalling it. Can be undone with Enable.")
        self.enable_button = QPushButton("Enable")
        self.enable_button.setVisible(False)
        self.enable_button.setToolTip("Re-enable the selected disabled app.")
